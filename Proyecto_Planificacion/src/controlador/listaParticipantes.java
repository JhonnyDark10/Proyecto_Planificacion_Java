...
public class listaParticipantes extends SelectorComposer{
	...
	// Instancia el objeto para acceso a datos.
		...
		public void nuevo(){
			...
			params.put("Participante", null);
			params.put("VentanaPadre", this);


			Window ventanaCargar = (Window)Executions.createComponents("/Z-Participantes/Participantes.zul", winListaParticipantes,params);
		...
		public void editar(){
			...
			//Enviar por parametros - para editar persona 
			Map<String, Object> params = new HashMap<String, Object>(); //Objeto Paramn tipo de objeto hasMap
			params.put("Participante", personaSelecionada);
			params.put("VentanaPadre", this);
		...
		public Participante getPersonaSelecionada() {
			return personaSelecionada;
		}

		public void setPersonaSelecionada(Participante personaSelecionada) {
				...
				public void onEvent(Event event) throws Exception {
					if (event.getName().equals("onYes")) {
						try {
							...
							personaSelecionada.setEstadoP("X");
